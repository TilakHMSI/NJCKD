...
export enum MgControlName {
    ScheduleEntry = "ScheduleEntry",
        ...
        Column8 = "Column8",
        WRK_CSCH_CONT = "WRK_CSCH_CONT",
        Column9 = "Column9",
        WRK_CSCH_CASE = "WRK_CSCH_CASE",
        Column10 = "Column10",
        WRK_CSCH_DATE = "WRK_CSCH_DATE",
        Column21 = "Column21",
        ...
        BtnSave="BtnSave",
        BtnCancel="BtnCancel",
        vDateSelect="vDateSelect",
        Btn_updateDate="Btn_updateDate"
}
...
export class MgFormControlsAccessor {
    ...
    get WRK_CSCH_LTNO(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_CSCH_LTNO);
    }
    ...
    get WRK_CSCH_CONT(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_CSCH_CONT);
    }

    get WRK_CSCH_CASE(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_CSCH_CASE);
    }

    get WRK_CSCH_DATE(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_CSCH_DATE);
    }
