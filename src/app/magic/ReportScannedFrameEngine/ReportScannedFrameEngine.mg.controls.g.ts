...
export enum MgControlName {
    ReportScannedFrameEngine = "ReportScannedFrameEngine",
        Edit1 = "Edit1",
        Edit2 = "Edit2",
        Edit3 = "Edit3",
        Label4 = "Label4",
...
export class MgFormControlsAccessor {
    ...
    get V_V_COUNT_2(): FormControl {
        return this.fg.controls[MgControlName.V_V_COUNT_2] as FormControl;
    }
