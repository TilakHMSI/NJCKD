...
export enum MgControlName {
    SELECTPURCHASECONTRACTLOT = "SELECTPURCHASECONTRACTLOT",
        ...
        Table3 = "Table3",
        Column4 = "Column4",
        WRK_PLT_SLFL = "WRK_PLT_SLFL",
        Column5 = "Column5",
        WRK_PLT_WRK_PLT_PCNO = "WRK_PLT_WRK_PLT_PCNO",
        Column6 = "Column6",
        WRK_PLT_WRK_PLT_LTNO = "WRK_PLT_WRK_PLT_LTNO",
        Column7 = "Column7",
...
export class MgFormControlsAccessor {
    ...
    get WRK_PLT_SLFL(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_PLT_SLFL);
    }

    get WRK_PLT_WRK_PLT_PCNO(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_PLT_WRK_PLT_PCNO);
    }

    get WRK_PLT_WRK_PLT_LTNO(): FormControl {
        return this.getTableChildFormControl(MgControlName.WRK_PLT_WRK_PLT_LTNO);
    }
